...
public class AuthenticationService {
    ...
    public synchronized User login(String email, String password) throws SpotifyException, NoSuchAlgorithmException {
        String entryToSearch = email + INTERVAL_REGEX + SHAAlgorithm.getHash(password);
    ...
    public synchronized void register(String email, String password) throws SpotifyException,
        ...
        String toWriteEntry = email + " " + SHAAlgorithm.getHash(password) + System.lineSeparator();
